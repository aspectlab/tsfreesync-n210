...
#define USRPIP          "addr=192.168.11.13"
...
int UHD_SAFE_MAIN(int argc, char *argv[]){
    ...
    while(not stop_signal_called){
        ...
        //For personal orginaztional purposes
        //Moves files to ~/N210_dev/DATDump directory
        // system("~/N210_dev/shell_scripts/move_dat_files.sh");
